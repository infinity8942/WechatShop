...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.classic.common.R.styleable.MultipleStatusView, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_emptyView, com.classic.common.R.layout.empty_view);
        mErrorViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_errorView, com.classic.common.R.layout.error_view);
        mLoadingViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_loadingView, com.classic.common.R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_noNetworkView, com.classic.common.R.layout.no_network_view);
        mContentViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_contentView, NULL_RESOURCE_ID);
        a.recycle();
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(com.classic.common.R.id.empty_retry_view);
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mErrorView) {
            mErrorView = view;
            View errorRetryView = mErrorView.findViewById(com.classic.common.R.id.error_retry_view);
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mNoNetworkView) {
            mNoNetworkView = view;
            View noNetworkRetryView = mNoNetworkView.findViewById(com.classic.common.R.id.no_network_retry_view);
