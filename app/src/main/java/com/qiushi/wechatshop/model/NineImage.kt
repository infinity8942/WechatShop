 ...
 * 素材宫格图片
 */
data class NineImage(var img_url: String, var oss_url: String, var mBounds: Rect?, var oss_id: Long, var size: Int, var base_url: String, var is_del: Int) : IThumbViewInfo, Parcelable, MultiItemEntity {
