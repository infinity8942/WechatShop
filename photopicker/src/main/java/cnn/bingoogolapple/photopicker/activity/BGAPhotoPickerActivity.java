...
import cnn.bingoogolapple.photopicker.adapter.BGAPhotoPickerAdapter;
import cnn.bingoogolapple.photopicker.imageloader.BGARVOnScrollListener;
import cnn.bingoogolapple.photopicker.model.BGAPhotoFolderModel;
import cnn.bingoogolapple.photopicker.pw.BGAPhotoFolderPw;
import cnn.bingoogolapple.photopicker.util.BGAAsyncTask;
import cnn.bingoogolapple.photopicker.util.BGALoadPhotoTask;
import cnn.bingoogolapple.photopicker.util.BGAPhotoHelper;
import cnn.bingoogolapple.photopicker.util.BGAPhotoPickerUtil;
import cnn.bingoogolapple.photopicker.util.StatusBarUtil;
...
public class BGAPhotoPickerActivity extends BGAPPToolbarActivity implements BGAOnItemChildClickListener, BGAAsyncTask.Callback<ArrayList<BGAPhotoFolderModel>> {
    ...
    protected void setListener() {
        ...
        if (getIntent().getBooleanExtra(EXTRA_PAUSE_ON_SCROLL, false)) {
            mContentRv.addOnScrollListener(new BGARVOnScrollListener(getApplicationContext()));
        }
    }
